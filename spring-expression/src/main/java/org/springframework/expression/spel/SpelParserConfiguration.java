...
public class SpelParserConfiguration {
	...
	public SpelParserConfiguration(@Nullable SpelCompilerMode compilerMode, @Nullable ClassLoader compilerClassLoader,
		...
		this.compilerMode = (compilerMode != null ? compilerMode : defaultCompilerMode);  // defaultCompilerMode
		this.compilerClassLoader = compilerClassLoader;
		this.autoGrowNullReferences = autoGrowNullReferences;  // false
		this.autoGrowCollections = autoGrowCollections;  // false
		this.maximumAutoGrowSize = maximumAutoGrowSize;  // Integer.MAX_VALUE
	}
