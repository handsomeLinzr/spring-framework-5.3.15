...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	...
	public ClassPathXmlApplicationContext(
			...
			throws BeansException {
		// 1.设置资源解析器 resourcePatternResolver = new PathMatchingResourcePatternResolver(this)
		// 2.设置父容器 parent，如果有parent，将父容器的环境配置合并到当前环境配置中
		super(parent);
		// 1.解析配置，比如el表达式，通过env进行解析
		// 保存配置文件路径，后边通过 getConfigLocations 获取当这个配置文件路径
