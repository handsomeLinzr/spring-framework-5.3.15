...
| `message` (output a string from a resources bundle based on the code parameter)
| <@spring.message code/>

| `messageText` (output a string from a resources bundle based on the code parameter,
...
----
	...
	<!-- Configure the Groovy Markup Template Engine... -->
	<mvc:groovy-configurer resources-loader-path="/WEB-INF/"/>
----
...
`InternalResourceViewResolver` can be used for dispatching to any Servlet resources but in
